...
exports.RosterModule = void 0;
const common_1 = require("@nestjs/common");
const roster_controller_1 = require("./roster.controller");
const roster_service_1 = require("./roster.service");
let RosterModule = class RosterModule {
};
exports.RosterModule = RosterModule;
exports.RosterModule = RosterModule = __decorate([
    (0, common_1.Module)({
        controllers: [roster_controller_1.RosterController],
