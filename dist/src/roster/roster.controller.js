...
let RosterController = class RosterController {
    ...
    findPublic(siteIdHeader) {
        return this.rosterService.findAll(this.getSiteId(siteIdHeader));
    }
    create(siteIdHeader, createDto, photoFile) {
    ...
    update(id, siteIdHeader, updateDto, photoFile) {
...
], RosterController.prototype, "findPublic", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Post)(),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('photoFile', { storage: storageOptions })),
    __param(0, (0, common_1.Headers)('x-site-id')),
    ...
    __metadata("design:returntype", void 0)
], RosterController.prototype, "create", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(),
    __param(0, (0, common_1.Headers)('x-site-id')),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], RosterController.prototype, "findAll", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], RosterController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)(':id'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('photoFile', { storage: storageOptions })),
    ...
    __metadata("design:returntype", void 0)
], RosterController.prototype, "update", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], RosterController.prototype, "remove", null);
